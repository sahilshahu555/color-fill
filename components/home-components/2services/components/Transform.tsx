...
const Transform = (props: Props) => {
  return (
    <div className="  bg-gradient-to-r from-[#D7F5EC] via-[#D2E6F6] to-[#D2E6F6]  pt-16">
       ...
       <h1 className="text-2xl md:text-3xl  md:text-[35px]  font-bold  text-center w-[90%] md:w-[70%] lg:w-[40%] m-auto tracking-wide leading-10 mb-6">Transform your images with colorfill</h1>
